export default {
    ...
    "disableauth.message2": "הוא מיועד לתרחישים <strong>שבהם אתה מתכוון ליישם אימות של צד שלישי</strong> מול CAmonitor כגון Cloudflare Access, Authelia או מנגנוני אימות אחרים.",
    ...
    aboutKumaURL: "אם תשאיר את השדה CAmonitor URL ריק, הוא יעבור כברירת מחדל לעמוד Project GitHub.",
    ...
    trustProxyDescription: "סמוך על כותרות 'x-forwarded-*'.אם אתה רוצה להשיג את ה- IP של הלקוח הנכון וה- CAmonitor שלך מאחור כמו Nginx או Apache, עליך לאפשר זאת.",
