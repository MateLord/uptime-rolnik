export default {
    ...
    "disableauth.message2": "Cette fonctionnalité est conçue pour les scénarios <strong>où vous avez l'intention d'implémenter une authentification tierce</strong> devant CAmonitor, comme Cloudflare Access, Authelia ou d'autres mécanismes d'authentification.",
    ...
    "CAmonitor URL": "URL vers CAmonitor",
    ...
    aboutKumaURL: "Si vous laissez l'URL d'CAmonitor vierge, elle redirigera vers la page du projet GitHub.",
    ...
    trustProxyDescription: "Faire confiance aux en-têtes 'X-Forwarded-*'. Si vous souhaitez obtenir la bonne adresse IP client et que votre CAmonitor se situe derrière (nginx ou Apache) vous devez l'activer.",
