export default {
    ...
    "disableauth.message2": "Jest przeznaczony dla <strong>kogoś, kto ma autoryzację zewnętrzną</strong> przed CAmonitor, taką jak Cloudflare Access.",
    ...
    aboutKumaURL: "Jeśli pozostawisz pole Adres CAmonitor puste, domyślnie będzie to strona projektu na GitHub.",
    ...
    trustProxyDescription: "Zaufaj nagłówkom 'X-Forwarded-*'. Jeśli chcesz uzyskać poprawne IP klienta, a twój CAmonitor jest za Nginx lub Apache, powinieneś to włączyć.",
