export default {
    ...
    "disableauth.message2": "Dies ist für Szenarien gedacht, <strong>in denen man eine externe Authentifizierung</strong> vor CAmonitor geschaltet hat, wie z.B. Cloudflare Access, Authelia oder andere Authentifizierungsmechanismen.",
    ...
    aboutKumaURL: "Wenn das Feld für die CAmonitor URL leer gelassen wird, wird standardmässig die GitHub Projekt Seite verwendet.",
    ...
    trustProxyDescription: "Vertraue 'X-Forwarded-*' headern. Wenn man die richtige client IP haben möchte und CAmonitor hinter einem Proxy wie Nginx or Apache läuft, wollte dies aktiviert werden.",
